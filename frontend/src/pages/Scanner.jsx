    ...
    try {
      ...
      const fallbackResult = {
        ...
        recommended_ingredients: [
          { ingredient: 'Niacinamide', reason: 'Balances sebum excretion and calms visible skin inflammation.' },
          { ingredient: 'Hyaluronic Acid', reason: 'Draws moisture into dermal layers without leaving a greasy residue.' },
          { ingredient: 'Ceramides', reason: 'Strengthens and repairs the skin barrier.' },
          { ingredient: 'SPF 50 Sunscreen', reason: 'Daily UV protection against pigmentation.' },
        ],
        product_recommendations: [
          { step_order: 1, step_name: 'Step 1 · Cleanse', step_icon: 'fa-solid fa-soap', badge_bg: 'rgba(43, 122, 75, 0.12)', badge_color: '#2b7a4b', category: 'Cleanser', brand: 'CeraVe', product: 'Salicylic Acid Cleanser', note: 'Gentle daily SA cleanser with ceramides for oily and combination skin.', ingredient: 'Salicylic Acid' },
          { step_order: 2, step_name: 'Step 2 · Exfoliate', step_icon: 'fa-solid fa-wand-magic-sparkles', badge_bg: 'rgba(217, 119, 6, 0.12)', badge_color: '#d97706', category: 'Exfoliant', brand: "Paula's Choice", product: 'Skin Perfecting 2% BHA Liquid', note: 'Gold-standard BHA exfoliant to unclog pores and smooth skin texture.', ingredient: 'Salicylic Acid' },
          { step_order: 4, step_name: 'Step 4 · Target Active', step_icon: 'fa-solid fa-flask', badge_bg: 'rgba(99, 102, 241, 0.12)', badge_color: '#4f46e5', category: 'Serum', brand: 'The Ordinary', product: 'Niacinamide 10% + Zinc 1%', note: 'Balances sebum production, calms redness, and visibly tightens pores.', ingredient: 'Niacinamide' },
          { step_order: 5, step_name: 'Step 5 · Moisture Barrier', step_icon: 'fa-solid fa-shield-halved', badge_bg: 'rgba(112, 123, 87, 0.15)', badge_color: '#404a32', category: 'Moisturizer', brand: 'CeraVe', product: 'Moisturizing Cream', note: 'Essential barrier repair ceramides in an oil-free, non-comedogenic base.', ingredient: 'Ceramides' },
          { step_order: 6, step_name: 'Step 6 · Sun Protection', step_icon: 'fa-solid fa-sun', badge_bg: 'rgba(234, 88, 12, 0.12)', badge_color: '#ea580c', category: 'Sunscreen', brand: 'La Roche-Posay', product: 'Anthelios UVMune 400 SPF 50+', note: 'Ultra broad-spectrum UV shield with a non-greasy matte finish.', ingredient: 'SPF 50 Sunscreen' },
        ],
        things_to_avoid: [
